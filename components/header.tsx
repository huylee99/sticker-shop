...
export default function Header() {
  ...
  return (
    <header className="bg-white shadow-sm">
      <nav className="mx-auto flex max-w-full items-center p-6 py-1 lg:px-8" aria-label="Global">
        <div className="inline-flex flex-1">
          <span className="sr-only">SkitSticker</span>
        ...
        {/* <Popover.Group className="hidden lg:flex lg:gap-x-12  ml-8">
        ...
        <Dialog.Panel className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
          <div className="flex items-center justify-between">
            <a href="#" className="-m-1.5 p-1.5">
              ...
              <Image className="h-8 w-8" width={32} height={32} src="/rainbow.png" alt="logo" />
            </a>
